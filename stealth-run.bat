...
mkdir "%APPDATA%\sylica-ai\temp" 2>nul
mkdir "%APPDATA%\sylica-ai\cache" 2>nul
mkdir "%APPDATA%\sylica-ai\screenshots" 2>nul
mkdir "%APPDATA%\sylica-ai\extra_screenshots" 2>nul
